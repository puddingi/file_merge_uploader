...
public class work_message_janus_archive_callback_converted_file  extends work_message
{	
	private work_unit _workUnit;
	
	public work_message_janus_archive_callback_converted_file()
	{
		Type = work_message.TYPE_JANUS_ARCHIVE_CALLBACK_CONVERTED_FILE;
	}
	...
	public void Process()
	{
		switch(_workUnit.GetProcessStatus())
		{
			...
			{
				log_handler.WriteFile(_workUnit.GetLogFullPathFileName(), "[STATUS_PROCESS_CALL_REQUEST_CONVERTED_FILE]");
			...
			{
				log_handler.WriteFile(_workUnit.GetLogFullPathFileName(), "[STATUS_PROCESS_CALL_REQUEST_MUXED_FILE]");
